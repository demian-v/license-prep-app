 ...
 */
export const TRIAL_EXPIRED_TEMPLATES: LocalizedTemplates = {
  en: {
 ...
 */
export const SUBSCRIPTION_EXPIRED_TEMPLATES: LocalizedTemplates = {
  en: {
 ...
 */
export const RENEWAL_SUCCESS_TEMPLATES: LocalizedTemplates = {
  en: {
 ...
 */
export const RENEWAL_FAILURE_TEMPLATES: LocalizedTemplates = {
  en: {
 ...
 */
export function getTrialExpiredTemplate(language: string): EmailTemplate {
  const lang = language as keyof LocalizedTemplates;
  return TRIAL_EXPIRED_TEMPLATES[lang] || TRIAL_EXPIRED_TEMPLATES.en;
}

/**
 * Get email template for subscription expired notification
 */
export function getSubscriptionExpiredTemplate(language: string): EmailTemplate {
  const lang = language as keyof LocalizedTemplates;
  return SUBSCRIPTION_EXPIRED_TEMPLATES[lang] || SUBSCRIPTION_EXPIRED_TEMPLATES.en;
}

/**
 * Get email template for renewal success notification
 */
export function getRenewalSuccessTemplate(language: string): EmailTemplate {
  const lang = language as keyof LocalizedTemplates;
  return RENEWAL_SUCCESS_TEMPLATES[lang] || RENEWAL_SUCCESS_TEMPLATES.en;
}

/**
 * Get email template for renewal failure notification
 */
export function getRenewalFailureTemplate(language: string): EmailTemplate {
  const lang = language as keyof LocalizedTemplates;
  return RENEWAL_FAILURE_TEMPLATES[lang] || RENEWAL_FAILURE_TEMPLATES.en;
}
