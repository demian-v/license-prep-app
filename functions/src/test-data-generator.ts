...
/**
 * Test data generator for subscription management system
 * Creates various subscription scenarios for testing the server-side expiration logic
 */
 ...
 */
export async function generateTestUsers(): Promise<TestUser[]> {
 ...
 */
export async function generateTestSubscriptions(testUsers: TestUser[]): Promise<TestSubscription[]> {
  const now = new Date();
 ...
 */
export async function createQuickTestScenario(): Promise<{
  userId: string;
 ...
 */
export async function verifyTestData(): Promise<{
  totalUsers: number;
  testUsers: number;
  totalSubscriptions: number;
  testSubscriptions: number;
  expiredTrialsReady: number;
  expiredSubscriptionsReady: number;
}> {
