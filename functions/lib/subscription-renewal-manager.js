...
exports.getRenewalStatistics = exports.processActiveSubscriptionRenewals = void 0;
 ...
 */
async function processActiveSubscriptionRenewals() {
...
exports.processActiveSubscriptionRenewals = processActiveSubscriptionRenewals;
/**
...
async function checkSubscriptionRenewals() {
    ...
    const result = { processed: 0, successful: 0, failed: 0, emailsSent: 0, errors: [] };
    try {
 ...
 */
async function renewSubscription(subscriptionData) {
    try {
 ...
 */
async function mockRenewalPayment(subscriptionData) {
 ...
 */
async function sendRenewalSuccessNotification(userId) {
    try {
 ...
 */
async function sendRenewalFailureNotification(userId) {
    try {
 ...
 */
async function logRenewalActivity(subscriptionData, action, success) {
    try {
        const currentBillingDate = subscriptionData.nextBillingDate.toDate();
 ...
 */
async function getRenewalStatistics() {
    const now = new Date();
...
exports.getRenewalStatistics = getRenewalStatistics;
//# sourceMappingURL=subscription-renewal-manager.js.map